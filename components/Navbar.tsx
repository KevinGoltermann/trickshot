        ...
        <div className='relative hidden md:block'>
          ...
          >
            <input 
              ...
              className='bg-primary p-3 md:text-medium font-md border-2 border-gray-200 focus:outline-none focus:border-2 focus:border-gray-300 w-[300px] md:w-[350px] rounded-full md:top-0'
            />
          ...
          {userProfile ? (
            <div className='flex gap-5 md:gap-10'>
              ...
              {userProfile['image'] && (
                <Link href='/'>
                <>
                  <Image width={40} height={40} className="rounded-full cursor-pointer" src={userProfile['image']} alt="profile picture"></Image>
                </>
              </Link>
              )}
