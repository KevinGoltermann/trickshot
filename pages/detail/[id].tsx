    ...
    <div className='flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap'>
      <div className='relative flex-2 w-[100px] lg:w-9/12 flex justify-center items-center bg-black'>
        ...
        <div className='absolute bottom-5 lg:bottom-10 right-5 lg:right-10 cursor-pointer'>
            {isVideoMuted ? (
              <button>
                <HiVolumeOff className='text-white text-2xl lg:text-4xl' onClick={() => setIsVideoMuted(false)} />
              </button>
            ) : (
              <button>
                <HiVolumeUp className='text-white text-2xl lg:text-4xl' onClick={() => setIsVideoMuted(true)} />
              </button>
            )}
        </div>
      </div>
